...
namespace ArisSkyve.Migrations
{
    ...
    [Migration("20260330101726_AddingJobTagAndChangingJobPosting")]
    partial class AddingJobTagAndChangingJobPosting
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ArisSkyve.Domain.Entities.JobTag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ArisSkyve.Domain.Entities.JobTag", b =>
                {
                    b.HasOne("ArisSkyve.Domain.Entities.JobPosting", "Job")
                        .WithMany()
                        .HasForeignKey("JobId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
